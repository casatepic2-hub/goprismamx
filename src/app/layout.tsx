...
export const metadata: Metadata = {
  ...
  description: 'Propiedades en Tepic, Nayarit. Casas, departamentos, terrenos y locales comerciales en venta y renta.',
  ...
  openGraph: {
    ...
    description: 'Propiedades en Tepic, Nayarit. Casas, departamentos, terrenos y locales comerciales.',
    type: 'website',
    locale: 'es_MX',
  ...
  twitter: {
    ...
    title: 'Prisma Real Estate | Propiedades en Venta y Renta',
    description: 'Propiedades en Tepic, Nayarit.',
    images: ['/og-image.jpg'],
  },
  robots: {
    index: true,
